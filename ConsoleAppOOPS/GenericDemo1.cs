...
namespace ConsoleAppOOPS
{
    class GenericDemo1
    {
        ...
        static void Main()
        {
            ...
            CheckAvailable(a, 78);//Int array & one int number. It can't take string array, string.
        ...
        static void GenCheckAvailable<T>(T[] arr, T no)//Generic Method: We have to give "T". That T type we have to pass in funct def.
        {
